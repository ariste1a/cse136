        ...
        return function $tooltip(type, prefix, defaultTriggerShow) {
            ...
            return {
                ...
                link: function link(scope, element, attrs) {
                    ...
                    function show() {
                        // console.log(btfcheck != null && $(element.context.parentElement).attr("btf-dragon") == null);
                        console.log(btfcheck != null);
                        if (btfcheck != null) {
                            if ($(element.context.parentElement).attr("btf-dragon") == null) {  //hackk..
                                return;
                            }
                        }
                        var position,
